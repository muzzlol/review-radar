...
# #     Args:
# #         reviews_list (list): List of review dictionaries with 'review_title' and 'review_text'.
# #         threshold (float): Probability threshold for classification.

# #     Returns:
# #         list: A list of dictionaries with the review text, confidence, label, and rating.
# #     """

# #     # Prepare the data for prediction
# #     test_data = [
# #         f"{review['review_title']} {review['review_text']}" for review in reviews_list
# #     ]
...
# #     # Prepare the data for prediction
# #     test_data = [
# #         " ".join(preprocess_text(f"{review['review_title']} {review['review_text']}"))
...
# #         result = {
# #             "review_text": test_data[i],
# #             "confidence": round(probabilities[i][0] * 100),
# #             "label": probabilities[i][0] < threshold,
# #             "rating": reviews_list[i]["rating"]
# #         }
...
# def detect_fake_reviews(reviews_list,text_process, threshold=0.70):
#     print("1 Available functions:", dir())
#     print("1 text_process available:", 'text_process' in dir())
#     """
...
#     # Combine review titles and texts
#     for review_dict in reviews_list:
#         test_data.append(review_dict["review_title"] + " " + review_dict["review_text"])
...
#             "label": probabilities[i, 0] < threshold,  # True if original, else generated
#             "rating": reviews_list[i]["rating"]
#         }
#         results.append(datum)
